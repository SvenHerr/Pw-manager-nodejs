...
!function(e, t) {
  ...
  var t = [], r = Object.getPrototypeOf, s = t.slice,
      ...
      a = y.toString, l = a.call(Object), v = {},
      m =
          function(e) {
  ...
  var d = function(n) {
    ...
    for (e in
             ...
             se.contains = function(
                 e, t) { return (e.ownerDocument || e) != C && T(e), v(e, t) },
             se.attr =
                 function(e, t) {
    ...
    return me.prototype = b.filters = b.pseudos, b.setFilters = new me,
           ...
           f = se.compile =
             ...
             if (!a) {
               ...
               (a = A(e, (y = o, m = 0 < (v = i).length, x = 0 < y.length,
                          r =
                              function(e, t, n, r, i) {
                                var o, a, s,
                                    u = 0, l = "0", c = e && [], f = [], p = w,
  ...
  var ze = [ "Webkit", "Moz", "ms" ], Ue = E.createElement("div").style,
      Xe = {};
  function Ve(e) {
  ...
  function Ze(e, t, n) {
    ...
    return (!v.boxSizingReliable() && i ||
            !v.reliableTrDimensions() && A(e, "tr") || "auto" === a ||
              ...
              get : function(e, t, n) {
                if (t)
                  return !Ge.test(S.css(e, "display")) ||
                             ...
                             ? Ze(e, u, n)
                             : Ie(e, Ye, function() { return Ze(e, u, n) })
              },
              set : function(e, t, n) {
                var r, i = Me(e),
  ...
  S.fn.extend({
    attr : function(e,
                    t) { return B(this, S.attr, e, t, 1 < arguments.length) },
    removeAttr : function(
  ...
  S.fn.extend({
    prop : function(e,
                    t) { return B(this, S.prop, e, t, 1 < arguments.length) },
    removeProp : function(
      ...
      S.fn.extend({
        addClass : function(t) {
          var e, n, r, i, o, a;
          return m(t)                 ? this.each(function(
                                            e) { S(this).addClass(t.call(this, e, vt(this))) })
  ...
  S.extend(S.event, {
    ...
    simulate : function(e, t, n) {
      ...
      v.focusin || S.each({focus : "focusin", blur : "focusout"}, function(n,
                                                                           r) {
  ...
  Wt.href = Tt.href, S.extend({
    ...
    ajaxSetup : function(
        e,
        t) { return t ? Bt(Bt(e, S.ajaxSettings), t) : Bt(S.ajaxSettings, e) },
    ajaxPrefilter : Ft(Rt),
    ajaxTransport : Ft(Mt),
    ajax : function(e, t) {
      ...
      var c, f, p, n, d, r, h, g, i, o,
          ...
          w = y.statusCode || {}, a = {}, s = {}, u = "canceled", T = {
            ...
            overrideMimeType : function(
                e) { return null == h && (y.mimeType = e), this },
      ...
      if (u = "abort", b.add(y.complete), T.done(y.success), T.fail(y.error),
        ...
        if (T.readyState = 1, g && m.trigger("ajaxSend", [ T, y ]), h)
          return T;
        y.async && 0 < y.timeout &&
            (d = C.setTimeout(function() { T.abort("timeout") }, y.timeout));
        try {
          h = !1, c.send(a, l)
        } catch (e) {
          if (h)
  ...
  S.trim = function(e) { return null == e ? "" : (e + "").replace(Gt, "$1") },
